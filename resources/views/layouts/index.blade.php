...
<body>
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            <!-- Single Slide -->
            <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(../frontend/img/bg-img/fairylights.jpg);">
                ...
                <div class="col-12">
                    ...
                    <div class="alime-projects-menu wow fadeInUp" data-wow-delay="100ms">
                        <div class="portfolio-menu text-center">
                            ...
                            <button class="btn" data-filter=".birthday">Birthday</button>
                            <button class="btn" data-filter=".concert">Concert</button>
                            <button class="btn" data-filter=".meeting">Meeting</button>
                        </div>
                    </div>
                </div>
            </div>
